export const servers = [
  {
    name: "🇮🇳 India Server",
    packages: [
      { product: "⭐ Starlight", price: "₹440" },
      { product: "🎫 Weekly Pass", price: "₹150" },
      { product: "🌙 Twilight Pass", price: "₹790" },
      { product: "5 Diamonds", price: "₹13" },
      { product: "11 Diamonds", price: "₹20" },
      { product: "22 Diamonds", price: "₹40" },
      { product: "33 Diamonds", price: "₹60" },
      { product: "55 Diamonds", price: "₹80" },
      { product: "86 Diamonds", price: "₹130" },
      { product: "110 Diamonds", price: "₹160" },
      { product: "141 Diamonds", price: "₹205" },
      { product: "168 Diamonds", price: "₹250" },
      { product: "220 Diamonds", price: "₹330" },
      { product: "275 Diamonds", price: "₹380" },
      { product: "312 Diamonds", price: "₹445" },
      { product: "706 Diamonds", price: "₹980" },
      { product: "878 Diamonds", price: "₹1250" },
      { product: "1220 Diamonds", price: "₹1700" },
      { product: "2195 Diamonds", price: "₹2950" },
      { product: "3688 Diamonds", price: "₹4950" },
      { product: "5532 Diamonds", price: "₹7250" },
      { product: "9288 Diamonds", price: "₹12250" }
    ]
  },
...

  {
    ...
    packages: [
      ...
      { product: "429 Diamonds", price: "₹770" },
      { product: "716 Diamonds", price: "₹1380" },
      { product: "1446 Diamonds", price: "₹2560" }
    ]
  },
...

  {
    ...
    packages: [
      ...
      { product: "223 Diamonds", price: "₹325" },
      { product: "279 Diamonds", price: "₹400" },
      { product: "336 Diamonds", price: "₹475" },
      { product: "570 Diamonds", price: "₹775" },
      { product: "1163 Diamonds", price: "₹1560" },
      { product: "2398 Diamonds", price: "₹3060" },
      { product: "6042 Diamonds", price: "₹7560" }
    ]
  }
];
